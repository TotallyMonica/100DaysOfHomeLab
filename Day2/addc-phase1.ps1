...
New-NetIPAddress -InterfaceIndex 1 -IPAddress "172.20.2.3" -AddressFamily IPv4 -PrefixLength 16 -DefaultGateway 172.20.0.1
Set-DnsClientServerAddress -InterfaceIndex 1 -ServerAddresses ("172.20.2.4","1.1.1.1")
